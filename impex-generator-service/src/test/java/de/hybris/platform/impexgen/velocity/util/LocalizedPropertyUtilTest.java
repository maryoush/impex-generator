...
public class LocalizedPropertyUtilTest
{
	...
	@Value("classpath:acceleratorservices/test/test-encoding/utf-data.test")
	...
	@Value("classpath:acceleratorservices/test/test-encoding/key-data-special-chars.test")
	...
	@Value("classpath:acceleratorservices/test/test-encoding/key-data-visible-chars.test")
	...
	@Value("classpath:acceleratorservices/test/test-encoding/key-data-specific.test")
	...
	@Value("classpath:acceleratorservices/test/test-encoding/japanese-utf-data.test")
